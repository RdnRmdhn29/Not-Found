...
/*
Raden Ramadhan :v
Support by : Blaze Team Bot
*/

require_once('./line_class.php');
require_once('./unirest-php-master/src/Unirest.php');

$channelAccessToken = 'PdsmCh2C+6eDn500wfcLnVnXDjNXoDenAfB5tYzHS5a/oisZE7V0jugdxMACee9dCZSjwAFJBi7i6D4ykp87qwOrk51gDqwhjj2lKO+qnl3/fEfyI8vYns/vF1lincHRu+4XJQ8wbEkX1iV/K82SYgdB04t89/1O/w1cDnyilFU='; //sesuaikan 
$channelSecret = '3bc539871774c084f1ec95a936790807';//sesuaikan
...
if ($type == 'join' || $command == 'Help') {
    $text = "Makasih dah mau invite aku ke grup!! Ketik Help untuk gunain aku\n";
    $text .= "Keyword Blaze ~~~\n";
    $text .= "> /anime-syn [text]\n";
    $text .= "> /anime [text]\n";
    $text .= "> /yt-get [link]\n";
